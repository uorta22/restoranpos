...
export function GoogleMapsTest() {
  ...
  const testStaticMapsAPI = async () => {
    try {
      const staticMapUrl = `https://maps.googleapis.com/maps/api/staticmap?center=41.0082,28.9784&zoom=13&size=400x300&markers=color:red%7C41.0082,28.9784&key=AIzaSyB1AowO-CY6iPdDA7s95GwTjK07b97cnF4`
  ...
  const testGeocodingAPI = async () => {
    try {
      const geocodingUrl = `https://maps.googleapis.com/maps/api/geocode/json?address=Istanbul,Turkey&key=AIzaSyB1AowO-CY6iPdDA7s95GwTjK07b97cnF4`
  ...
  const testDirectionsAPI = async () => {
    try {
      const directionsUrl = `https://maps.googleapis.com/maps/api/directions/json?origin=41.0082,28.9784&destination=41.015,28.985&key=AIzaSyB1AowO-CY6iPdDA7s95GwTjK07b97cnF4`
      ...
      <Card>
        ...
        <CardContent>
          {testResults.staticMap ? (
            <img
              src={`https://maps.googleapis.com/maps/api/staticmap?center=41.0082,28.9784&zoom=13&size=400x300&markers=color:red%7C41.0082,28.9784&key=AIzaSyB1AowO-CY6iPdDA7s95GwTjK07b97cnF4`}
