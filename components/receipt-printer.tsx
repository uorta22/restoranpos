...
export function ReceiptPrinter({ order, onClose }: ReceiptPrinterProps) {
  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex justify-between items-center">
        <h2 className="text-xl font-bold">Sipariş Fişi</h2>
      ...
      >
        ...
        <div className="mb-2">
          ...
          <div>Sipariş Tipi: {order.type || "Restoranda"}</div>
