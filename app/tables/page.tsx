      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-4">
          <div className="flex justify-between items-center mb-6">
            ...
            <Button onClick={() => {
              // Aktif sekmeye göre varsayılan alanı ayarla
              let defaultSection = "Ana Salon"
              if (activeTab === "bar") defaultSection = "Bar"
              else if (activeTab === "terrace") defaultSection = "Teras"
              else if (activeTab === "main") defaultSection = "Ana Salon"

              setTableSection(defaultSection)
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {mainTables.length > 0 ? (
                  ...
                  <div className="col-span-full">
                    <EmptyState type="tables" onAction={() => {
                      setTableSection("Ana Salon")
                      setIsAddDialogOpen(true)
                    }} actionLabel="İlk Masayı Ekle" />
                  </div>
                )}
              </div>
            </TabsContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {barTables.length > 0 ? (
                  ...
                  <div className="col-span-full text-center py-10">
                    <p className="text-gray-500 mb-4">Bu bölümde masa bulunmamaktadır.</p>
                    <Button onClick={() => {
                      setTableSection("Bar")
                      setIsAddDialogOpen(true)
                    }}>
