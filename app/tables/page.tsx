...
export default function TablesPage() {
  ...
  const handleAddTable = () => {
    try {
      ...
      if (existingTable) {
        toast({
          title: "Hata",
          description: "Bu masa numarası zaten kullanılıyor",
          variant: "destructive",
        })
        return
      }
  ...
  const handleEditTable = () => {
    try {
      ...
      // Aynı numaralı başka masa var mı kontrol et
      const existingTable = tables.find((t) => t.number === tableNumber && t.id !== selectedTable)
      if (existingTable) {
        toast({
          title: "Hata",
          description: "Bu masa numarası zaten kullanılıyor",
