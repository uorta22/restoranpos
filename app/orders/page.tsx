              ...
              <>
                ...
                {currentOrder.status === OrderStatus.PREPARING && (
                  <Button
                    ...
                    onClick={() => {
                      // Gel-Al siparişleri için direkt tamamlandı statüsüne geç
                      if (currentOrder.orderType === OrderType.TAKEAWAY) {
                        handleStatusChange(currentOrder.id, OrderStatus.COMPLETED)
                      } else {
                        handleStatusChange(currentOrder.id, OrderStatus.READY_FOR_SERVICE)
                      }
                    }}
                  >
                    {currentOrder.orderType === OrderType.TAKEAWAY ? "Teslim Et" : "Hazır"}
                  </Button>
                )}
